...
def check_args(args, data_dim):
    ...
    if args.NIW_prior_nu < data_dim + 1:
        ...
        args.NIW_prior_nu = data_dim + 1
        #raise Exception(f"The chosen NIW nu hyperparameter need to be at least D+1 (D is the latent dim). --NIW_prior_nu is now {args.NIW_prior_nu}. Set --NIW_prior_nu to at least {data_dim + 1}")
